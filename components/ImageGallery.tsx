    ...
    <section className="relative py-16 my-8 md:my-12">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
                ...
                <div className="relative w-full aspect-square sm:aspect-[4/3] md:aspect-[3/2] lg:col-span-2">
                  <Image
                    src={images[2].src}
                    alt={images[2].alt}
                    fill
                ...
                {/* Fifth image - taller */}
                <div className="relative w-full aspect-square sm:aspect-[4/3] md:aspect-[3/2] lg:aspect-[16/9] lg:col-span-3">
                  <Image
                    src={images[4].src}
                    alt={images[4].alt}
                    fill
